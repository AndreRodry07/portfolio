        ...
        <S.BoxMenu>
            ...
            <nav className={`nav-container ${menuvisivel ? "exibir" : ""}`}>
                <S.BoxList className={`menu ${menuvisivel ? "visivel" : ""}`}>
                    ...
                    <S.MyUl>
                        <li onClick={menuItemClicado} className="nav-item-one">
                            <Link to="/">Home</Link>
                        </li>
                        <li onClick={menuItemClicado} className="nav-item-two">
                            <Link to="/Sobre">Sobre</Link>
                        </li>
                        <li onClick={menuItemClicado} className="nav-item-three">
                            <Link to="/Projetos">Projetos</Link>
                        </li>
                        <li onClick={menuItemClicado} className="nav-item-four">
